...
- [x] **Repository Viewer**: Build a web interface to view repositories, including file browsing and commit history.

## Phase 2: User and Repository Management

- [x] **User Dashboard:** Create a dashboard for users to see their repositories.
- [x] **Repository Settings:** Allow users to manage repository settings, such as making them public or private.
...
- [ ] **Deployment Guide:** Write a comprehensive guide on how to self-host GitVex.
